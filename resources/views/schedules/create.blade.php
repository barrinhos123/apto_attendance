                        ...
                        <div>
                            ...
                            <div class="mt-1 flex gap-3 items-center">
                                <div class="flex items-center gap-2">
                                    <x-input id="duration_hours" type="number" name="duration_hours" min="0" max="24" :value="old('duration_hours', 8)" class="w-20" required />
                                    <span class="text-sm text-slate-600 dark:text-slate-400">{{ __('h') }}</span>
                                </div>
                                <div class="flex items-center gap-2">
                                    <x-input id="duration_minutes" type="number" name="duration_minutes" min="0" max="59" :value="old('duration_minutes', 0)" class="w-20" required />
